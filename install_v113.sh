...
echo "Installing TrendForge V113..."
...
# SQL
############################
cat > /root/trendforge-mvp/server/sql/migrate_v113.sql << 'EOF'
...
app = FastAPI(title="TrendForge Auth V113")
...
def health_v111():
    return {"status": "ok", "service": "trendforge-auth-v113"}
EOF

############################
# dashboard page upgraded with access checks
############################
...
echo "TrendForge V113 files installed successfully."
