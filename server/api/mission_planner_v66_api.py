...
OUT_PATH = os.path.join(BASE_DIR, "docs", "mission_planner_v66.json")
...
def main():
    ...
    for r in rows:
        ...
        items.append({
            ...
            "mission_action": r["mission_action"],
    ...
    print(f"[OK] mission_planner_v66_api wrote={OUT_PATH} items={len(items)}")
    conn.close()
