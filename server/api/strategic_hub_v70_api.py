...
OUT_PATH = os.path.join(BASE_DIR, "docs", "strategic_hub_v70.json")
...
def main():
    ...
    payload = {
        "ok": True,
        "version": "v70",
        "module": "strategic_hub",
        "summary": {
            "total": len(items),
            "by_hub_lane": dict(by_lane),
    ...
    print(f"[OK] strategic_hub_v70_api wrote={OUT_PATH} items={len(items)}")
    conn.close()
