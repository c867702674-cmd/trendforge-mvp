...
OUT_PATH = os.path.join(BASE_DIR, "docs", "dispatch_center_v75.json")
...
def main():
    ...
    for r in rows:
        ...
        items.append({
            ...
            "dispatch_action": r["dispatch_action"],
    ...
    print(f"[OK] dispatch_center_v75_api wrote={OUT_PATH} items={len(items)}")
    conn.close()
