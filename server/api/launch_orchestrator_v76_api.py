...
OUT_PATH = os.path.join(BASE_DIR, "docs", "launch_orchestrator_v76.json")
...
def main():
    ...
    payload = {
        ...
        "summary": {
            "total": len(items),
            "by_orchestrator_lane": dict(by_lane),
    ...
    print(f"[OK] launch_orchestrator_v76_api wrote={OUT_PATH} items={len(items)}")
    conn.close()
